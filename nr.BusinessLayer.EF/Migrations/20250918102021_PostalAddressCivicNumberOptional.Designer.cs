...
namespace nr.BusinessLayer.EF.Migrations
{
    ...
    [Migration("20250918102021_PostalAddressCivicNumberOptional")]
    partial class PostalAddressCivicNumberOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.AnswerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.AssessmentTestEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.AssessmentsDelivery", b =>
                {
                    ...
                    b.HasKey("AssessmentId", "UserId", "DeliveryDate");

                    b.HasIndex("UserId");

                    b.ToTable("AssessmentsDeliveries");
                });

            modelBuilder.Entity("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.QuestionAnswerEntity", b =>
                {
            ...
            modelBuilder.Entity("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.QuestionEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("nr.BusinessLayer.EF.DataLayer.Entities.Customers.CompanyEntity", b =>
                {
                    ...
                    b.HasIndex("FiscalCode", "VatCode")
                        .IsUnique()
                        .HasFilter("[FiscalCode] IS NOT NULL AND [VatCode] IS NOT NULL");

                    b.HasIndex("Pec", "Sdi")
                        .IsUnique()
                        .HasFilter("[Pec] IS NOT NULL AND [Sdi] IS NOT NULL");
            ...
            modelBuilder.Entity("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.AssessmentsDelivery", b =>
                {
                    b.HasOne("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.AssessmentTestEntity", "AssessmentTest")
                        .WithMany()
            ...
            modelBuilder.Entity("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.QuestionAnswerEntity", b =>
                {
                    b.HasOne("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.AnswerEntity", "Answer")
                        .WithMany()
                        .HasForeignKey("AnswerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("nr.BusinessLayer.EF.DataLayer.Entities.Assessments.QuestionEntity", "QuestionEntity")
                        .WithMany("Answers")
