...
namespace nr.PresentationLayer.Controllers.Api
{
    ...
    [ApiController]
    public class UsersController(IUserService userService, IConfiguration configuration) : ApiControllerBase()
    {
        ...
        [HttpPost("login")]
        public async Task<Results<Ok<TokenModel>, UnauthorizedHttpResult>> LoginUser([FromBody] LoginModel loginModel) {
        ...
        [HttpPost]
        public async Task<CreatedAtRoute<UserModel>> RegisterUser([FromBody] RegisterUserModel userModel) {
        ...
        public async Task<Ok<UserModel>> GetUserById([FromRoute] int userId) {
