...
namespace nr.BusinessLayer.EF.Migrations
{
    ...
    [Migration("20250128140236_PostalAddressFieldNameChanged_AttachmentLinkAdded")]
    partial class PostalAddressFieldNameChanged_AttachmentLinkAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("nr.BusinessLayer.EF.DataLayer.Entities.Customers.CompanyEntity", b =>
                {
                    ...
                    b.HasOne("nr.BusinessLayer.EF.DataLayer.Entities.Customers.Addresses.EmailAddressEntity", "Pec")
                        .WithMany()
                        .HasForeignKey("PecId");
